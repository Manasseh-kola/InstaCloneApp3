...
class PostsRepo {
    private val posts = listOf(
        Posts(
            ...
            "drake",
            R.drawable.story1,
            listOf(R.drawable.story4, R.drawable.story7)
        ),
        Posts(
            2, (100..500).random(),
        ...
        Posts(
            ...
            "ChefCurry",
            R.drawable.story3,
            listOf(R.drawable.story4, R.drawable.story7, R.drawable.user)
        ),
        Posts(
            4, (100..500).random(),
        ...
        Posts(
            ...
            "Dr Kenyon",
            R.drawable.story5,
            listOf(R.drawable.story6, R.drawable.story7)
        ),
        Posts(
            6, (100..500).random(),
